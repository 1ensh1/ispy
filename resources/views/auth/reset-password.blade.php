...
<head>
    ...
    <title>Reset Password — iSpy World</title>
    ...
    <div class="right-panel" style="width:60%; background-color:#f5f0e8; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:2.5rem 2rem;">
        ...
        <div class="form-card">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                {{-- Confirm Password --}}
                <div style="margin-bottom:1.1rem;">
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700" style="margin-bottom:0.35rem;">
                        Confirm Password
                    </label>
                    <input
                ...
                <button type="submit" class="sign-in-btn" style="margin-top:0.4rem;">Reset Password</button>
