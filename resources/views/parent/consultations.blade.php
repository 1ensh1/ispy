                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @elseif($booking->status === 'Completed')
                                    <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-700 border border-blue-200">Completed</span>
                                @elseif($booking->status === 'Cancelled')
                                    <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600 border border-gray-200">Cancelled</span>
                                @elseif($booking->status === 'Rejected' || $booking->status === 'No-show')
                                    <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-700 border border-red-200">{{ $booking->status }}</span>
                                @else
                                    <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600 border border-gray-200">{{ $booking->status }}</span>
                                @endif
                            </td>
                            <td class="px-6 py-4">
