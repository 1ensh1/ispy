...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6" id="password-section">
        ...
        <p class="text-sm text-gray-500 mb-5">
            This password allows your child to access the iSpy World mobile learning app at home.
            Enter it when prompted on the app to unlock your child's profile.
        </p>
        ...
        {{-- Flash messages for password form --}}
        ...
        <form method="POST" action="{{ route('parent.password.change') }}"
              id="pw-form" class="hidden mt-4 space-y-3 max-w-sm">
            @csrf
            <div>
