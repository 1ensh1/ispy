...
<head>
    ...
    <title>Your iSpy World Parent Account</title>
</head>
                    ...
                    <tr>
                        <td style="padding:36px 40px;">
                            ...
                            <p style="margin:0 0 16px 0; line-height:1.6;">
                                Welcome to the iSpy World portal! A parent account has been created for you at
                                <strong>Future Minds Academy</strong>. To get started, activate your account using the
                                link below. You'll review our Data Privacy Notice and Terms &amp; Conditions, and your
                                login credentials will be shown to you once activation is complete.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:16px 20px;">
                                        ...
                                        <p style="margin:0; font-size:14px; line-height:1.6; color:#78350f;">
                                            ...
                                            before you can log in. This link expires <strong>48 hours</strong> after this email was sent,
                                            so please activate soon.
                                        </p>
